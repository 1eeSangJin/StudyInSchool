...
<body>
  ...
  <?php
        ...
        $dao = new boardDao();
        $userNick = $dao->checkWelfareUser($num);
  ...
  <header>
    ...
    <div class = "column" id = "content">
      ...
      <br>
        ...
        <form action = "modifyWelfare.php?num=<?= $num ?>&page=<?= $page ?>" id = "wirteNotice" name = "writeNotice" method = "post" class = "ui form">
            ...
            <button type = "button" class = "ui secondary button" onclick = "location.href='welfareBoard.php'">돌아가기</button>
        </form>
    </div>
