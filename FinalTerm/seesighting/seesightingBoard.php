...
<body>
  ...
  <?php
        ...
        $NumOfComSeesighting = $dao->getNumOfSeesighting();

        if($NumOfComSeesighting > 0){
          $numPages = ceil($NumOfComSeesighting / NUM_LINES);
          ...
          $msgs = $dao->getAllseesighting($start, NUM_LINES);
  ...
  <header>
    ...
    <div class = "column" id = "content">
      ...
      <?php if($NumOfComSeesighting > 0) : ?>
        ...
        <br>
        <?php if($firstLink > 1) : ?>
          <a href="<?= bdUrl('seesightingBoard.php', 0, $page - NUM_PAGE_LINKS) ?>"><</a>&nbsp;
        <?php endif ?>

        <?php for($i = $firstLink; $i <= $lastLink; $i++) : ?>
          <?php if($i == $page) : ?>
            <a href="<?= bdUrl('seesightingBoard.php', 0 , $i) ?>"><b><?= $i ?></b></a>&nbsp;
          <?php else : ?>
            <a href="<?= bdUrl('seesightingBoard.php', 0 , $i) ?>"><?= $i ?></a>&nbsp;
          <?php endif ?>
        <?php endfor ?>
      ...
      <?php endif ?>
        ...
        <div style="float:right;">
          <button type = 'button' class = 'ui secondary button' onclick = location.href='writeSeesighting_form.php'>글쓰기</button>
        </div>
    </div>
