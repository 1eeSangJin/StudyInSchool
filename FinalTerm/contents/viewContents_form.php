...
<body>
  ...
  <?php
        ...
        $comments = $dao->getAllCommentContents($num);
        $count = $dao->countCommentContents($num);
      ...
      <div>
          ...
          <div id = "contents">
            <span style = "float:right;">
              <a href = "deleteContents.php?num=<?= $msgs['num'] ?>&page=<?= $page ?>" onclick = "return confirm('정말 삭제하시겠습니까?')" class = "ui secondary button">삭제</a>
              <button class = 'ui secondary button' onclick = "location.href='modifyContents_form.php?num=<?=$msgs['num'] ?>&page=<?= $page ?>'">수정</button>
              <button class = 'ui secondary button' onclick = "location.href='contentsBoard.php?page=<?= $page?>'">목록</button>
            </span>
            <br><br>
          <div>
            <?= $msgs['content'] ?>
