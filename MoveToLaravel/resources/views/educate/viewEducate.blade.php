...
<div class = "column" id = "content">
    ...
    <div id = "contents">
        <span style = "float:right;">
            <a href = "deleteEducate?id={{ $msgs['id'] }}&page={{ $page }}" onclick = "return confirm('정말 삭제하시겠습니까?')" class = "ui secondary button">삭제</a>
            <button class = 'ui secondary button' onclick = "location.href='modifyEducate_form?id={{ $msgs['id'] }}&page={{ $page }}'">수정</button>
            <button class = 'ui secondary button' onclick = "location.href='educateBoard?page={{ $page }}'">목록</button>
        </span>
        <br><br>
        <div>
            <?= $msgs['content'] ?>
