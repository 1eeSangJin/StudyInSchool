...
@section('content')
    ...
    @else
        <div class = "column" id = "content">
            ...
            <form action = "updat?id={{$id}}" method = "post" class = "ui form">
                @csrf
                ...
                <div class = "field">         
                    <label>{{ __('닉네임') }}</label>   
                    <div class = "four wide field">
                        <input type = "text" name = "userNick" id = "userNick" value = "{{ $user['userNick'] }}" required>
                    </div>
                </div>
                ...
                <button type = "button" class = "ui secondary button" onclick = "location.href='userList'">돌아가기</button>
            </form>
