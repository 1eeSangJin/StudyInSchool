...
@section('content')
    ...
    <form action = "modifySeesighting?id={{ $id }}&page={{ $page }}" method = "post" class = "ui form">
        @csrf
        ...
        <button type = "button" class = "ui secondary button" onclick = "location.href='seesightingBoard.php'">돌아가기</button>
    </form>
  </div>
@endsection
