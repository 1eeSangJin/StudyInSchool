...
class soldierController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $msgs = dept_board::where("dept_num", "=", "801")->orderBy('id', 'desc')->paginate(3);
        ...
        if(Auth::check()){
            ...
            return view('soldier.soldierBoard')
    ...
    public function create()
    {
        //
            ...
            return view('soldier.writeSoldier_form')
                ->with('results', $results);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('soldier/soldierBoard');
    }
    ...
    public function edit(Request $request)
    {
        ...
        if(Auth::user()['userNick'] == $msgs->userNick){
            ...
            return view('soldier.modifySoldier_form')
                ->with('results', $results)
                ->with('id', $id)
                ->with('page', $page)
                ->with('msgs', $msgs);
        }else{
            return redirect('soldier/soldierBoard?page='.$page)->with('message', '본인만 수정할 수 있습니다..');
        }
    }
