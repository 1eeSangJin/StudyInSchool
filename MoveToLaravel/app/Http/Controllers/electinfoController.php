...
class electinfoController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $msgs = dept_board::where("dept_num", "=", "301")->orderBy('id', 'desc')->paginate(3);
        ...
        if(Auth::check()){
            ...
            return view('electinfo.electinfoBoard')
                ->with('count', $arr)
    ...
    public function create()
    {
        //
            ...
            return view('electinfo.writeElectinfo_form')
                ->with('results', $results);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('electinfo/electinfoBoard');
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('electinfo.viewElectinfo')
            ->with('results', $results)
            ->with('id', $id)
            ->with('page', $page)
            ->with('count', $count)
    ...
    public function edit(Request $request)
    {
        ...
        if(Auth::user()['userNick'] == $msgs->userNick){
            ...
            return view('electinfo.modifyElectinfo_form')
                ->with('results', $results)
                ->with('id', $id)
                ->with('page', $page)
                ->with('msgs', $msgs);
        }else{
            return redirect('electinfo/electinfoBoard?page='.$page)->with('message', '본인만 수정할 수 있습니다..');
        }
    }
    ...
    public function destroy(Request $request)
    {
        ...
        if(Auth::user()['userNick'] == $msgs->userNick){
            ...
            return redirect('electinfo/electinfoBoard')->with('message', $id . '번 글이 삭제되었습니다.');
        }else{
            return redirect('electinfo/electinfoBoard?page=' . $page)->with('message', '본인만 삭제할 수 있습니다');
        }
    }
}
