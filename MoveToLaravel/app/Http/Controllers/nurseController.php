...
class nurseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $msgs = dept_board::where("dept_num", "=", "1201")->orderBy('id', 'desc')->paginate(3);
    ...
    public function create()
    {
        //
            ...
            return view('nurse.writeNurse_form')
                ->with('results', $results);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('nurse/nurseBoard');
    }
    ...
    public function edit(Request $request)
    {
        ...
        if(Auth::user()['userNick'] == $msgs->userNick){
            ...
            return view('nurse.modifyNurse_form')
                ->with('results', $results)
                ->with('id', $id)
                ->with('page', $page)
                ->with('msgs', $msgs);
        }else{
            return redirect('nurse/nurseBoard?page='.$page)->with('message', '본인만 수정할 수 있습니다..');
        }
    }
    ...
    public function destroy(Request $request)
    {
        ...
        if(Auth::user()['userNick'] == $msgs->userNick){
            ...
            return redirect('nurse/nurseBoard')->with('message', $id . '번 글이 삭제되었습니다.');
        }else{
            return redirect('nurse/nurseBoard?page=' . $page)->with('message', '본인만 삭제할 수 있습니다');
        }
    }
}
