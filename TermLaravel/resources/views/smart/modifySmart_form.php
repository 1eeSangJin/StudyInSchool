  ...
  <header>
    ...
    <div class = "column" id = "content">
      ...
      <br>
        ...
        <form action = "modifySmart.php?num=<?= $num ?>&page=<?= $page ?>" method = "post" class = "ui form">
            ...
            <button type = "button" class = "ui secondary button" onclick = "location.href='smartBoard.php'">돌아가기</button>
        </form>
    </div>
