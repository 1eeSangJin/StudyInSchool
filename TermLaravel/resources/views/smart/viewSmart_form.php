...
<body>
  ...
  <?php
        ...
        $dao = new boardDao();
        $msgs = $dao->getSmart($num);
        $comments = $dao->getAllCommentSmart($num);
        $count = $dao->countCommentSmart($num);
      ...
      <div>
          ...
          <div id = "contents">
            <span style = "float:right;">
              <a href = "deleteSmart.php?num=<?= $msgs['num'] ?>&page=<?= $page ?>" onclick = "return confirm('정말 삭제하시겠습니까?')" class = "ui secondary button">삭제</a>
              <button class = 'ui secondary button' onclick = "location.href='modifySmart_form.php?num=<?=$msgs['num'] ?>&page=<?= $page ?>'">수정</button>
              <button class = 'ui secondary button' onclick = "location.href='smartBoard.php?page=<?= $page?>'">목록</button>
            </span>
            <br><br>
          <div>
            <?= $msgs['content'] ?>
