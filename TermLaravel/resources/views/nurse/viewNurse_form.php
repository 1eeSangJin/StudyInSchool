...
<body>
  ...
  <?php
        ...
        $dao = new boardDao();
        $msgs = $dao->getNurse($num);
        $comments = $dao->getAllCommentNurse($num);
        $count = $dao->countCommentNurse($num);
      ...
      <div>
          ...
          <div id = "contents">
            <span style = "float:right;">
              <a href = "deleteNurse.php?num=<?= $msgs['num'] ?>&page=<?= $page ?>" onclick = "return confirm('정말 삭제하시겠습니까?')" class = "ui secondary button">삭제</a>
              <button class = 'ui secondary button' onclick = "location.href='modifyNurse_form.php?num=<?=$msgs['num'] ?>&page=<?= $page ?>'">수정</button>
              <button class = 'ui secondary button' onclick = "location.href='nurseBoard.php?page=<?= $page?>'">목록</button>
            </span>
            <br><br>
          <div>
            <?= $msgs['content'] ?>
